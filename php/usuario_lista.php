        ...
        foreach ($datos as $rows) {
            $tabla .= '
                <tr class="has-text-centered" >
                    ...
                    <td>
                        <a href="index.php?vista=user_update&user_id_up=' . $rows['usuario_id'] . '" class="btn btn-warning">Actualizar</a>
                    </td>
                    <td>
                        <a href="#" onclick="confirmarEliminar(' . $rows['usuario_id'] . ')" class="btn btn-danger">Eliminar</a>
                    </td>
                </tr>
            ';
            $contador++;
...
<script>
    function confirmarEliminar(id) {
        if (confirm("¿Está seguro de que desea eliminar este usuario?")) {
            window.location.href = '<?php echo $url . $pagina; ?>&user_id_del=' + id;
        }
    }
</script>
