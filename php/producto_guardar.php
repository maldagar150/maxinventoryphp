<?php
	...
	$almacen=limpiar_cadena($_POST['producto_almacen']);


	/*== Verificando campos obligatorios ==*/
    if($codigo=="" || $nombre=="" || $precio=="" || $stock=="" || $almacen==""){
        echo '
    ...
    $check_almacen=$check_almacen->query("SELECT almacen_id FROM almacen WHERE almacen_id='$almacen'");
    ...
    $guardar_producto=$guardar_producto->prepare("INSERT INTO producto(producto_codigo,producto_nombre,producto_precio,producto_stock,producto_foto,almacen_id,usuario_id) VALUES(:codigo,:nombre,:precio,:stock,:foto,:almacen,:usuario)");
